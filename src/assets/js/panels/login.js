 ...
 */
const { AZauth, Mojang } = require('./assets/js/minecraft-core/Index.js');
  ...
  async getMicrosoft() {
    ...
    microsoftBtn.addEventListener('click', () => {
      popupLogin.openPopup({
        ...
        content: 'Por favor sea paciente...',
        color: 'var(--color)'
      });
  ...
  async getCrack() {
    ...
    connectOffline.addEventListener('click', async () => {
      if (emailOffline.value.length < 3) {
        popupLogin.openPopup({
          title: 'Error',
          content: 'Su nombre debe tener mas de 3 caracteres.',
          options: true
        });
        return;
      }
      ...
      if (emailOffline.value.match(/ /g)) {
        popupLogin.openPopup({
          title: 'Error',
          content: 'Su nombre no puede tener espacios.',
          options: true
        });
        return;
      }
  ...
  async getAZauth() {
    ...
    AZauthConnectBTN.addEventListener('click', async () => {
      ...
      if (AZauthEmail.value == '' || AZauthPassword.value == '') {
        PopupLogin.openPopup({
          title: 'Error',
          content: 'Por favor complete todos los datos.',
          options: true
        });
        return;
      }
